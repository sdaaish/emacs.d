...
#+BEGIN_SRC emacs-lisp
  ...
  (defvar my/mobile-files (my/read-lines (concat my/org-directory ".mobile-files")))
#+END_SRC
* Config
** Initializing
*** Message-buffer
...
#+BEGIN_SRC emacs-lisp
  (use-package powershell
    :commands powershell
    :config
    (setq powershell-eldoc-def-files (expand-file-name "eldoc/powershell-eldoc.el" my/init-dir)))
#+END_SRC
*** Dos-mode
Only in windows.
#+BEGIN_SRC emacs-lisp
...
"Org mode stuff"
    ("c" org-gcal-sync "Sync Google Calender")

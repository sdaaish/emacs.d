...
(use-package search-web
 ...
 :defer t
 :config
  (setq search-web-default-browser "firefox"
        search-web-in-emacs-browser "eww"
        search-web-external-browser "firefox"))
#+END_SRC
...
(setq org-directory (concat my-dropbox-dir "Appar/MobileOrg/"))
